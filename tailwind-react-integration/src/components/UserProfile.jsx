...
function UserProfile() {
    return (
      <div className="user-profile
       ...
       hover:shadow-xl
       ">
        <img className="rounded-full w-36 h-36 mx-auto sm:w-24 sm:h-24 md:w-36 md:h-36 hover:scale-110 transition-transform duration-300 ease-in-out" src="/JohnDoe.jpeg" alt="User" />
